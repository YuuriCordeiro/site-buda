...
const Hero: React.FC = () => {
  ...
  return (
    <section className="w-full min-h-[604px] flex flex-col md:flex-row items-center justify-between pt-32 pb-0 px-5">
      
      {/* Container centralizado */}
      <div className="max-w-[1200px] mx-auto w-full flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="flex-1 flex justify-center md:justify-end">
          <img
            ...
            className="w-full max-w-[550px] md:max-w-[600px] h-auto object-contain rounded-lg transition-transform duration-500"
